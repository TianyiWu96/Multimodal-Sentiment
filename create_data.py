...
# read data from csv
# will combine the utterance in the same video
# will provide the user train and test split
...
print(len(train)) #1447 
print("has added to train")
print(len(test))  #752
print("has added to test")
